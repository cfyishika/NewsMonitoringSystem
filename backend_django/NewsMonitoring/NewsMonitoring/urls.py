...
urlpatterns = [
    ...
    path('api/source_list/',api.SourceList,name='source_list'),
    path('api/source_list/<int:pk>', api.SourceDetail, name='source_detail'),
    path('api/company_list/',api.CompanyList,name='company_list'),
